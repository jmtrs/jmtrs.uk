...
Use this file as the repository entrypoint for Codex. Shared operating guidance lives in `AI_AGENTS.md`, but the rules below are the minimum required context for safe work in this repo.
...
- Shared workflow enforcement lives in versioned repo scripts, `.githooks/`, and CI, not in provider-specific AI hooks.
